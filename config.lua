...
Config.AttackTypes = {
	...
	},
    {
		...
		animation = {
			dict = "creatures_mammal@horse@melee@attacks@kick",
			name = "attack_180_att"
		},
		radius = 3.0,
		force = 3.0,
	...
	},
    {
		...
		animation = {
			dict = "creatures_mammal@cat@melee@base",
			name = "hit_from_left"
		},
		radius = 3.0,
		force = 3.0,
